...
import CategoryMain from "@/components/admin-dashboard/categoryadmin/CategoryMain";
import AdminGuard from "@/utils/AdminGuard";
import CreateCategoryModal from "@/components/admin-dashboard/categoryadmin/CreateCategoryModal";
    ...
    <Fragment>
      <AdminGuard>
        <div className={styles.container}>
          ...
          <CreateCategoryModal isOpen={openCreateModal} onClose={toggleModal} />
        </div>
      </AdminGuard>
    </Fragment>
  );
